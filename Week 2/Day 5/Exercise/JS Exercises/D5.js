...
const newObject = {
  ...
  model: '3',
  color: 'white',
  trims: ['base', 'long-range', 'performance'],
  licensePlate: 'GT453PF'
}
...
for(let i=0 ; i < cars.length ; i++){
  let indexLastItemTrims = cars[i].trims.length -1
  delete cars[i].trims[indexLastItemTrims]
}
